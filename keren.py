...
wait = {
    ...
    'timeline':False,
    'autoAdd':False,
    'message':"""Thanks for add https://line.me/R/ti/p/%40kyx3655e""",
    "lang":"JP",
    "comment":"""Thanks for add https://line.me/R/ti/p/%40kyx3655e""",
    "commentOn":True,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
...
#------------------NOTIFIED_READ_MESSAGE----------------#
        ...
        if op.type == 26:
            ...
            if "@"+cl.getProfile().displayName in msg.text:
                if wait["tag2"] == True:
                    tanya = msg.text.replace("@"+cl.getProfile().displayName,"")
                    jawab = "[Auto respon]\n "+cl.getProfile().displayName+" kenapa tag tag?"
                    jawaban = (jawab)
